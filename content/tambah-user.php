...
if(isset($_POST["edit"])) {
    ...
    // ubah user kolam apa yang mau di ubah (SET), yang mau di ubah id ke berapa
            ...
            <fieldset class="border border-black border-2 p-3">
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="radio"
                            name="jenis_kelamin"
                            value="Laki-laki" <?php echo isset($_GET['edit']) ? ($rowEdit['jenis_kelamin'] == 'Laki-laki' ? 'checked' : '') : ''?>> Laki-laki
                        <input type="radio"
                            name="jenis_kelamin"
                            value="Perempuan" <?php echo isset($_GET['edit']) ? ($rowEdit['jenis_kelamin'] == 'Perempuan' ? 'checked' : '') : ''?>> Perempuan
                    </div>
                    <div class="mb-3">
